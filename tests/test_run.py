...
from aehf.cli import demo_transcripts
from aehf.core.case import EvalCase
from aehf.core.loader import load_suite
from aehf.core.runner import run_case, run_suite
from aehf.core.transcript import Step, Termination
from tests.slowagent import SlowAgent, TrackingAgent

case = EvalCase(id = "2", task_prompt = "hi", tools = [],success_criteria = {"acc":90},max_steps = 1,timeout_seconds  = 0.05,token_budget = 10)
