...
case = EvalCase(id = "2", task_prompt = "hi", tools = [],success_criteria=SuccessCriteria(answer_regex = "6",required_tools = ["calculator"],forbidden_tools = []),max_steps = 1,timeout_seconds  = 10,token_budget = 10,tool_fixtures = {'search' : "hekko"},)
